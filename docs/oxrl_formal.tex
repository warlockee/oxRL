...
\begin{table}[ht]
\centering
\caption{Qwen2.5-32B on GSM8K (8-shot strict-match, seed 42; single-seed cells). The small-scale ranking is fully reversed: SimPO (worst at $\leq$1.5B) is best; \sprft{} (best at $\leq$3B) gains nothing over base. \sprft{}'s gain over base collapses $+23.2$~pp (1.5B) $\to$ $+1.6$ (7B) $\to$ $+0.1$ (32B).}
\label{tab:qwen32b}
\small
\begin{tabular}{@{}lcc@{}}
\toprule
