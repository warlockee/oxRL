...
\begin{figure}[h]
\centering
\begin{tikzpicture}[x=1.05cm, y=0.07cm]
  % axes
  \draw[->, thick] (-0.25, 0) -- (5.7, 0) node[right, font=\small] {model size};
  \draw[->, thick] (-0.25, 0) -- (-0.25, 70) node[above, font=\small] {GSM8K \%};
  % y ticks
  \foreach \y/\lab in {0/30, 20/50, 40/70, 60/90} {
  ...
  % SP-RFT (orange-ish): 33.97, 54.36, 55.70, 77.38, 84.5
  \draw[orange!85!black, thick]
    (0, 3.97) -- (1.3, 24.36) -- (2.1, 25.70) -- (3.6, 47.38) -- (4.8, 54.5);
  \foreach \p in {(0,3.97),(1.3,24.36),(2.1,25.70),(3.6,47.38),(4.8,54.5)}
    \fill[orange!85!black] \p circle (0.06cm);
  \node[orange!85!black, font=\scriptsize] at (1.5, 30) {SP-RFT};
  % DPO (blue): 33.97, 49.08, 34.55, 83.38, 86.78
  \draw[blue!75!black, thick, dashed]
    (0, 3.97) -- (1.3, 19.08) -- (2.1, 4.55) -- (3.6, 53.38) -- (4.8, 56.78);
  \foreach \p in {(0,3.97),(1.3,19.08),(2.1,4.55),(3.6,53.38),(4.8,56.78)}
    \fill[blue!75!black] \p circle (0.06cm);
  \node[blue!75!black, font=\scriptsize] at (3.0, 12) {DPO};
  % SimPO (teal): 26.08, 38.67, --, 83.32, 86.48 (skip 3B with dashed gap)
  \draw[teal!80!black, thick, dotted]
    (0, -3.92) -- (1.3, 8.67) -- (3.6, 53.32) -- (4.8, 56.48);
  \foreach \p in {(0,-3.92),(1.3,8.67),(3.6,53.32),(4.8,56.48)}
    \fill[teal!80!black] \p circle (0.06cm);
  \node[teal!80!black, font=\scriptsize] at (4.0, 60) {SimPO};
  % inversion annotation
  \draw[->, gray!70!black, thick]
    (2.85, 50) .. controls (3.1, 45) and (3.3, 40) .. (3.5, 38);
  \node[gray!50!black, font=\scriptsize\itshape] at (2.6, 53) {inversion};
\end{tikzpicture}
