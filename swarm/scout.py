...
from swarm.config_generator import generate_config, save_config, make_slug
from swarm.model_registry import check_chat_template, get_model_info
...
def _task_for_entry(entry: dict) -> str:
    ...
    """
    from swarm.config_generator import TASK_MAP
